<?php
// nurse/register.php - Nurse Registration Page
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($firstName) || empty($lastName) || empty($email) || empty($password)) {
        ...
        try {
            // Check if email already exists in nurses table
            $stmt = $pdo->prepare("SELECT nurse_id FROM nurses WHERE email = ?");
            $stmt->execute([$email]);
            ...
            if ($stmt->rowCount() > 0) {
                ...
                // Insert new nurse into the database (is_active defaults to 0 for admin approval)
                $insertStmt = $pdo->prepare("
                    INSERT INTO nurses (first_name, last_name, email, phone, password_hash, is_active) 
                    VALUES (?, ?, ?, ?, ?, 0)
                ");
...
<head>
    ...
    <title>Nurse Registration - LuminaCare</title>
        ...
        <div class="auth-container row g-0">
            ...
            <div class="col-md-5 auth-sidebar">
                <div>
                    ...
                    <h2 class="mt-5 fw-bold">Join the Nursing Staff</h2>
                    <p class="opacity-75 mt-3 fs-5">Enhance patient care and assist healthcare providers with our integrated maternal health tools.</p>
                </div>
            ...
            <div class="col-md-7 auth-form-wrapper">
                <div class="mb-4">
                    <h3 class="fw-bold text-dark">Nurse Registration</h3>
                    <p class="text-muted">Register your credentials. <br><span class="text-primary small fw-bold" style="color: var(--nurse-theme) !important;"><i class="bi bi-info-circle-fill me-1"></i> Admin verification required before access.</span></p>
                </div>
                ...
                <form method="POST" action="register.php" novalidate>
                    ...
                    <div class="text-center mt-4">
                        <small class="text-muted">By registering, you agree to our <a href="#" class="text-decoration-none" style="color: var(--nurse-theme);">Terms of Service</a> and <a href="#" class="text-decoration-none" style="color: var(--nurse-theme);">Privacy Policy</a>.</small>
                    </div>
                </form>
            </div>
        </div>
